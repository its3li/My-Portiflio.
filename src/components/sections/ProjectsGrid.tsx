...
const ProjectsGrid = forwardRef<HTMLDivElement, ProjectsGridProps>(({
  ...
  const { t } = useTranslation();
    ...
    const projects = [
    {
      ...
      imageUrl: "https://i.postimg.cc/nLGw3ygg/quantum.png",
    ...
    },
    {
      ...
      imageUrl: "https://i.postimg.cc/wBpGcqfD/Screenshot-6.png",
    ...
    },
    {
      ...
      imageUrl: "https://i.postimg.cc/zGWQgbjJ/dreamator.png",
    ...
    },
    {
      ...
      imageUrl: "https://i.postimg.cc/DzktjdZJ/cover-how-to-make-a-discord-bot.png",
